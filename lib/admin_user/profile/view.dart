...
class ProfilePage extends GetView<ProfileController> {
  ...
  void showEditDialog(BuildContext context) {
    ...
    nameController.text = controller.state.name.value;
    phoneController.text = controller.state.phone.value;
    addressController.text = controller.state.address.value;
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              controller.state.name.value = nameController.text;
              controller.state.address.value = addressController.text;
              controller.state.phone.value = phoneController.text;
